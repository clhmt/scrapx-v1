...
export default function CreateWanted() {
    ...
    const conditions = ["Scrap", "Regrind", "Repro (Granules)", "Virgin", "Off-Grade", "Bales", "Rolls"]; // EKLENDİ
    ...
    const [formData, setFormData] = useState({
        title: "", material_type: "Plastic", category: "",
        condition: "Scrap", // EKLENDİ
                    ...
                    <div className="w-full md:w-2/3 p-10">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                ...
                                {/* CONDITION (GERİ GELDİ) */}
                                <div>
                                    <label className="block text-sm font-bold mb-2">Condition</label>
                                    <select name="condition" value={formData.condition} onChange={handleChange} className="w-full p-3 border rounded-lg">
