...
// Supabase join bazen follower'ı array döndürebiliyor; normalize edeceğiz.
        ...
        {loading ? (
          ...
          <div className="bg-white p-12 text-center rounded-xl border border-gray-200 shadow-sm">
            ...
            <p className="text-gray-500 mt-2">
              When other traders follow you, they'll appear here.
            </p>
          </div>
        ) : (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-green-700 font-medium truncate">
                      {isPremiumViewer ? profile.company_name || "ScrapX Member" : "ScrapX Member"}
                    </p>
                    <p className="text-xs text-gray-500 truncate">
                      {profile.business_type} •{" "}
                      {profile.city && profile.country ? `${profile.city}, ${profile.country}` : "Global"}
                    </p>
                  </div>
